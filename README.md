...
---
此为**主菜单**  
![主菜单样式](Picture/readme//main_menu.jpg)  
此为**查询界面**  
![查询界面样式](Picture/readme//decode_menu.jpg)  
...
数据库格式：型号名 速度(km/h)(无符号整数) 车厢数(无符号整数) 命名 起始车号(无符号整数) 终止车号(无符号整数) 科普网址链接  
"-"命令（在某一区间删除子区间）：-型号名 起始车号(无符号整数) 终止车号(无符号整数)
